...
class ManufacturerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Manufacturer')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Manufacturer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Manufacturer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Manufacturer:edit.html.twig")
     */
